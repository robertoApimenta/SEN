...
export const DashEditarFuncionario = (props) => {
    ...
    const editAluno = async e => {
        e.preventDefault()
        if (senha === senha1) {
            await axios.put(url + "/edit_aluno", { id, nome, sobrenome, email, telefone, endereco, cidade, estado, pais, universidade, curso, estudo, ano, senha })
                .then(() => {
                    setAlerta({
                        type: 'success',
    ...
    return (
        <div className={classes.root}>
            ...
            >
                ...
                <Divider />
                <List>
                    <ListItem component={Link} to={"/novo_aluno/"} button>
                        <ListItemIcon>
                            <PersonAddIcon />
                        </ListItemIcon>
                        <ListItemText primary="Novo aluno" />
                    </ListItem>
                    <ListItem component={Link} to={"/estuda_em/" } button>
                        <ListItemIcon>
                            <MenuBookIcon />
                        </ListItemIcon>
                        <ListItemText primary="Estuda em" />
                    </ListItem>
                    <ListItem component={Link} to={"/meus_dados/"} button>
                        <ListItemIcon>
                            <StorageIcon />
                        </ListItemIcon>
                        <ListItemText primary="Meus dados" />
                    </ListItem>
                    <ListItem component={Link} to={"/total_alunos/"} button>
                        <ListItemIcon>
                            <BarChartIcon />
                        </ListItemIcon>
